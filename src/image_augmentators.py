# Compat shim: imgaug 0.4.0 uses numpy aliases (np.bool/np.float/...) removed in
# numpy>=1.24. Restore them before importing imgaug. Runs in dataloader workers
# too (they import this module). Safe: only sets attributes that are missing.
import numpy as _np
